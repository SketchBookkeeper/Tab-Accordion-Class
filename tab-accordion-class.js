...
import { mobileWidth, debounce } from './utilities';
 ...
 * @param {Boolean} closeOnClick // tabs will always closed when clicked, otherwise they will only close when clicked on mobile
...
function openDeepLinkedTab(triggers) {
	window.addEventListener('load', () => {
		...
		$('html, body').animate({ scrollTop: activeTrigger.offset().top });
	});
}
